...
QBCore.Functions.CreateUseableItem("pistol_box", function(source, item) 
    TriggerClientEvent("consumables:client:PistolAmmoBox", source, item.name) end)

QBCore.Functions.CreateUseableItem("ar_box", function(source, item) 
    TriggerClientEvent("consumables:client:AssaultAmmoBox", source, item.name) end)

QBCore.Functions.CreateUseableItem("SMGAmmoBox", function(source, item) 
    TriggerClientEvent("consumables:client:PistolAmmoBox", source, item.name) end)
