...
RegisterNetEvent('consumables:client:PistolAmmoBox', function()
    local playerPed = PlayerPedId()
    QBCore.Functions.Progressbar('pistol_box', 'Unpacking Bullets', 5000, false, true, { 
        ...
        TriggerServerEvent("QBCore:Server:RemoveItem", "pistol_box", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["pistol_box"], "remove")
        TriggerServerEvent("QBCore:Server:AddItem", "pistol_ammo", 20)
        ...
        QBCore.Functions.Notify("Ok edi wag", "error")        
    end)
    
end)

RegisterNetEvent('consumables:client:AssaultAmmoBox', function()
    local playerPed = PlayerPedId()
    QBCore.Functions.Progressbar('ar_box', 'Unpacking Bullets', 15000, false, true, { 
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerServerEvent("QBCore:Server:RemoveItem", "ar_box", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["ar_box"], "remove")
        TriggerServerEvent("QBCore:Server:AddItem", "rifle_ammo", 20)
...
RegisterNetEvent('consumables:client:SMGAmmoBox', function()
    local playerPed = PlayerPedId()
    QBCore.Functions.Progressbar('smg_box', 'Unpacking Bullets', 10000, false, true, { 
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerServerEvent("QBCore:Server:RemoveItem", "smg_box", 1)
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["smg_box"], "remove")
        TriggerServerEvent("QBCore:Server:AddItem", "smg_ammo", 20)
